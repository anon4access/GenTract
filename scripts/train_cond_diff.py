...
def main():
    ...
    name         = f'diff_{model_dim}_{num_tl}'
    ...
    #===================================================
    # check_dir = os.path.join(base_dir, "results", f'diff_{model_dim}_{num_tl}_v2')
    # checkpoint_path = os.path.join(check_dir,'best_model_2.pth')
